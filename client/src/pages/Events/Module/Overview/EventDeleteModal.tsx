...
const EventDeleteModal = ({ open, onClose, event_id }: EventDeleteModalProps) => {
        ...
        >
            <EventFiCard >
                ...
                <Stack direction="row-reverse"  mt={2} spacing={1}>
                    <EventFiButton variant="contained" color="error" label='Delete' onClick={() => handleEventDelete() } />
                    <EventFiButton variant="outlined" color="error" label='Cancel' onClick={() => onClose()} />
                </Stack>
            </EventFiCard>
        </EventFiModal>
    )
