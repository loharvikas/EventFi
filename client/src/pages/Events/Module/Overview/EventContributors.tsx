                            ...
                            <Stack mt={1} key={index}>
                                <Stack mb={1} key={index} direction="row" alignItems="center" spacing={1} justifyContent={'space-between'} >
                                    <Stack direction={'row'} spacing={1}>
                                        <EventFiAvatar 
                                            initials={contributor.guest.name.charAt(0)}
                                        />
                                        <Stack direction={'column'} >
                                            <Typography variant="body2">{contributor.guest.name}</Typography>
                                            <Typography variant="subtitle2">{contributor.guest.email}</Typography> 
                                        </Stack>
                                    </Stack>
                                    <Stack direction={'column'} spacing={1}>
                                        <Typography variant="subtitle2">Contributation</Typography>
                                        <Typography variant="body2" fontWeight={'bold'}>{contributor.amount + ' INR'}</Typography>    
                                    </Stack>
                                </Stack>
                                <Divider/>
                            </Stack>
